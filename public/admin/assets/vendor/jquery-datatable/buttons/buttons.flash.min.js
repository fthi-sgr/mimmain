    ...
    function w(a) {
        q === p &&
            (q =
                ...
                u
                    .serializeToString(
                        h.parseXML(m["xl/worksheets/sheet1.xml"])
                    )
                    .indexOf("xmlns:r"));
        ...
        action: function (a, b, d, c) {
            ...
            var a = c._flash,
                ...
                d = {
                    ...
                    xl: {
                        _rels: {
                            "workbook.xml.rels": h.parseXML(
                                m["xl/_rels/workbook.xml.rels"]
                            ),
                        },
            ...
            b.messageBottom &&
                (g([b.messageBottom], e), n(e, k.header.length - 1));
            g = o(f, "cols");
