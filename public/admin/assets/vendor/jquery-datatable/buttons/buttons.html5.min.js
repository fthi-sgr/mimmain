(function (j) {
    ...
    function y(a, c) {
        u === q &&
            (u =
                ...
                w
                    .serializeToString(
                        j.parseXML(z["xl/worksheets/sheet1.xml"])
                    )
                    .indexOf("xmlns:r"));
    ...
    m.ext.buttons.excelHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            o.messageBottom &&
                (i([o.messageBottom], f), m(f, d.header.length - 1));
            c = p(g, "cols");
    ...
    m.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            c = {
                ...
                content: [
                    { table: { headerRows: 1, body: c }, layout: "noBorders" },
                ],
                styles: {
                    tableHeader: {
                        bold: !0,
