!(function (e, t) {
    ...
    var h = (function (n) {
                            ...
                            (ce(function (e) {
                                ...
                                (s.appendChild(e).innerHTML =
                                    ...
                                    e.querySelectorAll("[id~=" + C + "-]")
                                        .length || m.push("~="),
                                    (t = x.createElement("input")).setAttribute(
                                        "name",
                                        ""
                                    ),
                                    e.appendChild(t),
        ...
        (ae.attr = function (e, t) {
            ...
            var n = _.attrHandle[t.toLowerCase()],
                i =
                    n && A.call(_.attrHandle, t.toLowerCase())
                        ? n(e, t, !T)
                        : void 0;
            return void 0 !== i
                ? i
    ...
    function qe(n, i, r, o) {
        ...
        var e,
            ...
            h = i[0],
            p = y(h);
        if (p || (1 < f && "string" == typeof h && !v.checkClone && Ne.test(h)))
                    ...
                    i ||
                        ...
                        (l &&
                            ...
                            e.isPropagationStopped() &&
                                f.addEventListener(h, wt),
                            n[h](),
                            e.isPropagationStopped() &&
                                f.removeEventListener(h, wt),
    ...
    function Nt(n, e, i, r) {
        ...
        else for (t in e) Nt(n + "[" + t + "]", e[t], i, r);
    }
    ...
    (function (e, t) {
                ...
                return (
                    (e.toggle = function () {
                        ...
                        this._element.hasAttribute("disabled") ||
                            ...
                            e && p(this._element).toggleClass(m));
                    }),
                    (e.dispose = function () {
                ...
                return (
                    ...
                    (e.to = function (e) {
                        ...
                        if (!(e > this._items.length - 1 || e < 0))
                            if (this._isSliding)
                                p(this._element).one(k, function () {
                                    return t.to(e);
                                });
                            else {
                                if (n === e)
                    ...
                    (e._getConfig = function (e) {
                        return (
                            (e = l(l({}, T), e)), g.typeCheckConfig(_, e, C), e
                        );
                    }),
                    ...
                    (o._jQueryInterface = function (i) {
                        return this.each(function () {
                            ...
                            if (
                                (e ||
                                    ((e = new o(this, t)), p(this).data(w, e)),
                                "number" == typeof i)
                            )
                                e.to(i);
        ...
        p(document).on(
            ...
            (p.fn[_].noConflict = function () {
                return (p.fn[_] = x), O._jQueryInterface;
            });
        var L = "collapse",
            I = "bs.collapse",
            q = p.fn[L],
            ...
            U = (function () {
                ...
                return (
                    ...
                    (e._addAriaAndCollapsedClass = function (e, t) {
                        ...
                        t.length &&
                            p(t).toggleClass(B, !n).attr("aria-expanded", n);
                    }),
        ...
        p(document).on("click.bs.collapse.data-api", W, function (e) {
            ...
            (p.fn[L].noConflict = function () {
                return (p.fn[L] = q), U._jQueryInterface;
            });
        var Q =
        ...
        function te(e) {
            ...
            for (
                var t = ee(10) ? document.body : null,
        ...
        function Se(e, t, n, i) {
            (n.updateBound = i),
                Ce(e).addEventListener("resize", n.updateBound, {
                    passive: !0,
                });
            var r = K(e);
            return (
        ...
        var Fe = {
                ...
                modifiers: {
                    ...
                    preventOverflow: {
                        ...
                        fn: function (e, i) {
                            var t =
                                i.boundariesElement || te(e.instance.popper);
                    ...
                    flip: {
                        ...
                        enabled: !0,
                        fn: function (m, v) {
                            if (xe(m.instance.modifiers, "inner")) return m;
                            if (
                                m.flipped &&
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            return (
                                (e.attributes = ce({}, O, e.attributes)),
            ...
            Me = (function () {
                function o(e, t) {
                    ...
                    !(function (e, t) {
                        ...
                        Object.keys(
                            ce({}, o.Defaults.modifiers, i.modifiers)
                        ).forEach(function (e) {
            ...
            Tt = (function () {
                ...
                return (
                    ...
                    (e._showElement = function (e) {
                        ...
                        if (n) {
                            var s = g.getTransitionDurationFromElement(
                                this._dialog
                            );
                            p(this._dialog)
                    ...
                    (e._setEscapeEvent = function () {
                        ...
                        this._isShown
                            ...
                            : this._isShown || p(this._element).off(mt);
                    }),
                    ...
                    (r._jQueryInterface = function (n, i) {
                        return this.each(function () {
                            ...
                            if (
                                (e ||
                                    ((e = new r(this, t)), p(this).data(st, e)),
                                "string" == typeof n)
                            ) {
                                if (void 0 === e[n])
                                    throw new TypeError(
                            ...
                            (function (e, t) {
                                ...
                                if (-1 !== t.indexOf(n))
                                    return (
                                        -1 === Ct.indexOf(n) ||
                                        Boolean(
                                            e.nodeValue.match(Dt) ||
                                                e.nodeValue.match(kt)
                                        )
                                    );
                                for (
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if (
                                ...
                                (e ||
                                    ((e = new i(this, t)), p(this).data(jt, e)),
                                "string" == typeof n)
                            ) {
                                if (void 0 === e[n])
                                    throw new TypeError(
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if (
                                (e || !/dispose|hide/.test(n)) &&
                                (e ||
                                    ((e = new i(this, t)), p(this).data(Xt, e)),
                                "string" == typeof n)
                            ) {
                                if (void 0 === e[n])
                                    throw new TypeError(
                ...
                return (
                    ...
                    (e._getConfig = function (e) {
                        if (
                            ...
                            t ||
                                ((t = g.getUID(rn)), p(e.target).attr("id", t)),
                                (e.target = "#" + t);
                        }
                        return g.typeCheckConfig(rn, e, un), e;
                    }),
        ...
        p(window).on("load.bs.scrollspy.data-api", function () {
            ...
            (p.fn[rn] = gn._jQueryInterface),
            (p.fn[rn].Constructor = gn),
            (p.fn[rn].noConflict = function () {
                return (p.fn[rn] = an), gn._jQueryInterface;
            });
        var mn = "bs.tab",
            vn = p.fn.tab,
            yn = "active",
            ...
            wn = (function () {
                ...
                return (
                    ...
                    (e.dispose = function () {
                        p.removeData(this._element, mn), (this._element = null);
                    }),
        ...
        (p.fn[En] = jn._jQueryInterface),
            (p.fn[En].Constructor = jn),
            (p.fn[En].noConflict = function () {
                return (p.fn[En] = Cn), jn._jQueryInterface;
            }),
            (e.Alert = c),
            (e.Button = b),
            (e.Carousel = O),
