!(function (t, e) {
    ...
    ((o = r.prototype).axisX = function (t, e, n) {
        ...
        (o.generateTicks = function (t) {
            ...
            return (
                0 < i.length && 0 < i[0] && i.unshift(i[0] - (i[1] - i[0])), i
            );
        }),
    ...
    ((a = _.prototype).init = function () {
        ...
        (a.updateXAxisTickValues = function (t, e) {
            ...
            return (
                ...
                e
                    ? e.tickValues(n)
                    : (i.xAxis.tickValues(n), i.subXAxis.tickValues(n)),
                n
            );
        }),
        (a.getYAxis = function (t, e, n, i, r, a, o) {
            var s = this.owner,
                ...
                l = new this.internal(this, c).axis
                    .scale(t)
                    .orient(e)
                    .tickFormat(n);
            return (
                ...
                n.axis_x_tick_format &&
                    (h(n.axis_x_tick_format)
                        ...
                        : e.isTimeSeries() &&
                          (i = function (t) {
                              return t
                                  ? e.axisTimeFormat(n.axis_x_tick_format)(t)
                                  : "";
                          })),
                h(i)
                    ? function (t) {
            ...
            return (
                (e && o.currentMaxTickWidths[t]) ||
                    ...
                    (o.currentMaxTickWidths[t] =
                        u <= 0 ? o.currentMaxTickWidths[t] : u)),
                o.currentMaxTickWidths[t]
            );
        }),
    ...
    return (
        ...
        (m.initParams = function () {
            ...
            (t.clipId = "c3-" + +new Date() + "-clip"),
                ...
                (t.rotated_padding_right =
                    n.axis_rotated && !n.axis_x_show ? 0 : 30),
        ...
        (m.initWithData = function (t) {
            ...
            (i.axis = new _(i)),
                ...
                i.config.svg_classname &&
                    i.svg.attr("class", i.config.svg_classname),
                (e = i.svg.append("defs")),
                ...
                (n = i.main =
                    i.svg
                        .append("g")
                        .attr("transform", i.getTranslate("main"))),
                ...
                F.length
                    ? (V.updateXDomain(F, u, c, l),
                      R.axis_x_tick_values ||
                          (T = V.axis.updateXAxisTickValues(F)))
        ...
        (m.transformMain = function (t, e) {
            ...
            e && e.axisX
                ? (n = e.axisX)
                : ((n = a.main.select("." + X.axisX)),
                  t && (n = n.transition())),
                e && e.axisY
                    ? (i = e.axisY)
                    : ((i = a.main.select("." + X.axisY)),
                      t && (i = i.transition())),
                e && e.axisY2
                    ? (r = e.axisY2)
                    : ((r = a.main.select("." + X.axisY2)),
                      t && (r = r.transition())),
        ...
        (m.parseDate = function (t) {
            ...
            return (
                t instanceof Date
                    ? (e = t)
                    : "string" == typeof t
                    ? (e = this.dataTimeFormat(this.config.data_xFormat).parse(
                          t
                      ))
                    : "object" === (void 0 === t ? "undefined" : s(t))
                    ? (e = new Date(+t))
                    ...
                    (n.prototype._parseNumber = function () {
                        ...
                        if (
                            ...
                            if (this._currentIndex != s)
                                for (
                                    var u = this._currentIndex - 1, c = 1;
                                    s <= u;
        ...
        (y.category = function (t, e) {
            ...
            return (
                1 < arguments.length &&
                    ((i.axis_x_categories[t] = e), n.redraw()),
        ...
        (y.focus = function (e) {
            ...
            (e = n.mapToTargetIds(e)),
                (t = n.svg.selectAll(
                    n.selectorTargets(e.filter(n.isTargetToShow, n))
                )),
                this.revert(),
                this.defocus(),
                ...
                (n.defocusedTargetIds = n.defocusedTargetIds.filter(function (
                    t
                ) {
        ...
        (y.groups = function (t) {
            var e = this.internal,
                n = e.config;
            return (
                void 0 === t || ((n.data_groups = t), e.redraw()), n.data_groups
            );
        }),
        (y.legend = function () {}),
            ...
            t.mouse && (n = t.mouse),
                t.data
                    ? i.isMultipleX()
                        ? ((n = [
                              i.x(t.data.x),
                              i.getYScale(t.data.id)(t.data.value),
                          ]),
                          (e = null))
                        : (e = P(t.data.index)
                              ? t.data.index
            ...
            (i = s
                        ...
                        o.interaction_enabled
                            ? function (t) {
                                  var e,
                                      n = r.updateAngle(t);
                                  n &&
                                      ((e = [r.convertToArcData(n)]),
                                      r.showTooltip(e, this));
                              }
                            : null
                    )
                    .on(
                        ...
                        o.interaction_enabled
                            ? function (t, e) {
                                  ...
                                  i &&
                                      ...
                                      r.toggleShape &&
                                          r.toggleShape(this, n, e),
                                      r.config.data_onclick.call(
                                          r.api,
                                          n,
                                          this
                                      ));
                ...
                s
                    ...
                    .style("font-size", function (t) {
                        return r.isGaugeType(t.data)
                            ? Math.round(r.radius / 5) + "px"
                            : "";
                    })
                    .transition()
                    .duration(t)
                    .style("opacity", function (t) {
                        return r.isTargetToShow(t.data.id) &&
                            r.isArcType(t.data)
                            ? 1
                            : 0;
                    }),
                s
                    ...
                    .style(
                        "opacity",
                        r.hasType("donut") || r.hasType("gauge") ? 1 : 0
                    ),
                r.hasType("gauge") &&
                    (r.arcs
                        .select("." + X.chartArcsBackground)
                        .attr("d", function () {
                            var t = {
                    ...
                    r.arcs
                        ...
                        .attr(
                            ...
                            -1 *
                                (r.innerRadius +
                                    (r.radius - r.innerRadius) /
                                        (o.gauge_fullCircle ? 1 : 2)) +
                                "px"
                        )
                        .attr("dy", "1.2em")
                        .text(
                            o.gauge_label_show
                                ? r.textForGaugeMinMax(o.gauge_min, !1)
                                : ""
                        ),
                    r.arcs
                        ...
                        .text(
                            o.gauge_label_show
                                ? r.textForGaugeMinMax(o.gauge_max, !0)
                                : ""
                        ));
        }),
        ...
        (m.getCaches = function (t) {
            ...
            for (e = 0; e < t.length; e++)
                t[e] in this.cache &&
                    n.push(this.cloneTarget(this.cache[t[e]]));
            return n;
        }),
        ...
        (m.classArc = function (t) {
            return (
                this.classShape(t.data) + this.generateClass(X.arc, t.data.id)
            );
        }),
        (m.classArcs = function (t) {
            return (
                this.classShapes(t.data) + this.generateClass(X.arcs, t.data.id)
            );
        }),
        ...
        (m.classFocused = function (t) {
            return (
                " " +
                (0 <= this.focusedTargetIds.indexOf(t.id) ? X.focused : "")
            );
        }),
                ...
                n.forEach(function (n) {
                    ...
                    u.isCustomX() || u.isTimeSeries()
                        ? 0 <= r.indexOf(e)
                            ...
                            : C(c.data_xs) &&
                              (u.data.xs[n] = u.getXValuesOfXKey(
                                  e,
                                  u.data.targets
                              ))
        ...
        (m.orderTargets = function (t) {
            ...
            return (
                e &&
                    (t.sort(e),
                    (this.isOrderAsc() || this.isOrderDesc()) && t.reverse()),
                t
            );
        }),
        ...
        (m.load = function (n, i) {
            ...
            n &&
                ...
                (i.type || i.types) &&
                    n.forEach(function (t) {
                        var e =
                            i.types && i.types[t.id] ? i.types[t.id] : i.type;
        ...
        (m.loadFromArgs = function (e) {
            ...
            e.data
                ...
                : e.json
                ? n.load(
                      n.convertDataToTargets(
                          n.convertJsonToData(e.json, e.keys)
                      ),
                      e
                  )
                : e.rows
                              ...
                              n.legend &&
                                  n.legend
                                      .selectAll(
                                          "." +
                                              X.legendItem +
                                              n.getTargetSelectorSuffix(e)
                                      )
                                      .remove(),
                              (n.data.targets = n.data.targets.filter(function (
                                  t
                              ) {
                                  return t.id !== e;
                              }));
            ...
            return (
                ...
                0 === x.length
                    ...
                    : (isNaN(y) && (y = 0),
                      ...
                      void 0 !== w &&
                          ((m = w + (s = Math.max(Math.abs(y), Math.abs(m)))),
                          (y = w - s)),
                      A
                ...
                .on("mousemove", function (t) {
                    ...
                    r.dragging ||
                        ...
                        (r.isStepType(t) &&
                            ...
                            (n -= 1),
                        (e = r
                            .filterTargetsToShow(r.data.targets)
                            .map(function (t) {
                                return r.addName(
                                    r.getValueOnIndex(t.values, n)
                                );
                            })),
                        o.tooltip_grouped &&
                            (r.showTooltip(e, this), r.showXGridFocus(e)),
                        (!o.tooltip_grouped ||
                    ...
                    a.dragging ||
                        ...
                        e
                            ? ((n = (
                              ...
                              a.showXGridFocus(n),
                              (a.isBarType(e.id) ||
                                  a.dist(e, t) < s.point_sensitivity) &&
                                  (a.svg
                                      .select("." + X.eventRect)
                                      .style("cursor", "pointer"),
                                  a.mouseover ||
                                      (s.data_onmouseover.call(a.api, e),
                                      (a.mouseover = e))))
                            : r());
                })
                .on("click", function () {
                            ...
                            a.main
                                ...
                                .each(function () {
                                    (s.data_selection_grouped ||
                                        a.isWithinShape(this, e)) &&
                                        (a.toggleShape(this, e, e.index),
                                        a.config.data_onclick.call(
                                            a.api,
                                            e,
                                            this
                                        ));
            ...
            (e = n.mapToTargetIds(e)),
                n.legend
                    ...
                    .style("opacity", function () {
                        return (
                            t ? n.opacityForLegend : n.opacityForUnfocusedLegend
                        ).call(n, n.d3.select(this));
                    });
        }),
        ...
        (m.updateLegend = function (p, t, e) {
            ...
            (p = p.filter(function (t) {
                return (
                    !(void 0 !== w.data_names[t]) || null !== w.data_names[t]
                );
            })),
        ...
        (m.getScale = function (t, e, n) {
            return (n ? this.d3.time.scale() : this.d3.scale.linear()).range([
                t,
                e,
            ]);
        }),
        ...
        (m.updateScales = function () {
            ...
            (e.xMin = t.axis_rotated ? 1 : 0),
                ...
                (e.y = e.getY(
                    e.yMin,
                    e.yMax,
                    n ? t.axis_y_default : e.y.domain()
                )),
                (e.y2 = e.getY(
                    e.yMin,
                    e.yMax,
                    n ? t.axis_y2_default : e.y2.domain()
                )),
            ...
            a.data_selection_enabled &&
                ...
                (a.data_selection_multiple ||
                    i.main
                        ...
                        .each(function (t, e) {
                            var n = r.select(this);
                            n.classed(X.SELECTED) &&
                                u(!1, n.classed(X.SELECTED, !1), t, e);
                        }),
        ...
        (m.getBars = function (t, e) {
            return (
                e
                    ? this.main.selectAll(
                          "." + X.bars + this.getTargetSelectorSuffix(e)
                      )
                    : this.main
        ...
        (m.expandBars = function (t, e, n) {
            n && this.unexpandBars(),
                this.getBars(t, e).classed(X.EXPANDED, !0);
        }),
        ...
        (m.getShapeOffset = function (t, s, e) {
            var u = this,
                c = u.orderTargets(
                    u.filterTargetsToShow(u.data.targets.filter(t, u))
                ),
                l = c.map(function (t) {
                    return t.id;
                });
        ...
        (m.generateDrawLine = function (t, s) {
            ...
            return (
                ...
                function (t) {
                    var e,
                        n = c.line_connectNull
                            ? u.filterRemoveNull(t.values)
                            : t.values,
                        i = s ? u.x : u.subX,
                        r = h.call(u, t.id),
                        a = 0,
        ...
        (m.generateDrawArea = function (t, e) {
            ...
            return (
                ...
                function (t) {
                    var e,
                        n = o.line_connectNull
                            ? a.filterRemoveNull(t.values)
                            : t.values,
                        i = 0,
                        r = 0;
                    return (
                        a.isAreaType(t)
                            ? (a.isStepType(t) &&
                                  (n = a.convertValuesToStep(n)),
                              (e = s.interpolate(a.getInterpolate(t))(n)))
                            : (n[0] &&
                                  ((i = a.x(n[0].x)),
                                  (r = a.getYScale(t.id)(n[0].value))),
                              (e = o.axis_rotated
                                  ? "M " + r + " " + i
                                  : "M " + i + " " + r)),
                        e || "M 0 0"
        ...
        (m.updateCircle = function () {
            ...
            (t.mainCircle = t.main
                ...
                t.mainCircle.style(
                    "opacity",
                    t.initialOpacityForCircle.bind(t)
                ),
        ...
        (m.initSubchart = function () {
            ...
            n.style("visibility", i),
                ...
                (t.axes.subx = n
                    ...
                    .style(
                        "visibility",
                        e.subchart_axis_x_show ? i : "hidden"
                    ));
        }),
        ...
        (m.redrawSubchart = function (t, e, n, i, r, a, o) {
            ...
            l.context.style(
                "visibility",
                d.subchart_show ? "visible" : "hidden"
            ),
                d.subchart_show &&
                    (h.event &&
                        "zoom" === h.event.type &&
        ...
        (m.getDefaultExtent = function () {
            ...
            return (
                t.isTimeSeries() &&
                    (n = [t.parseDate(n[0]), t.parseDate(n[1])]),
                n
            );
        }),
        (m.initText = function () {
        ...
        (m.redrawText = function (t, e, n, i) {
            return [
                (i ? this.mainText.transition() : this.mainText)
                    ...
                    .style(
                        "fill-opacity",
                        n ? 0 : this.opacityForText.bind(this)
                    ),
            ];
        }),
        ...
        (m.getTooltipContent = function (t, e, n, i) {
            ...
            for (p && t.sort(p), a = 0; a < t.length; a++)
                if (
                    ...
                    void 0 !==
                        (s = x(
                            g(t[a].value, t[a].ratio, t[a].id, t[a].index, t)
                        )))
                ) {
        ...
        (m.tooltipPosition = function (t, e, n, i) {
            ...
            return (
                d
                    ? ((a =
                          (c.width -
                              (c.isLegendRight ? c.getLegendWidth() : 0)) /
                              2 +
                          f[0]),
                      (s = c.height / 2 + f[1] + 20))
                    : ((r = c.getSvgLeft(!0)),
        ...
        (m.setTargetType = function (t, e) {
            ...
            n.mapToTargetIds(t).forEach(function (t) {
                (n.withoutFadeIn[t] = e === i.data_types[t]),
                    (i.data_types[t] = e);
            }),
                t || (i.data_type = e);
        }),
    ...
    (function () {
        ...
        function vt(t, e, n) {
            ...
            return ot(
                ...
                200 *
                    (r -
                        lt((0.0193339 * t + 0.119192 * e + 0.9503041 * n) / Da))
            );
        }
        function yt(t) {
        ...
        function ye(t, e, n, i, s) {
            ...
            if (
                ...
                for (var r = 0, a = n, o = c.length; r < o; ++r)
                    c[r].e = a = !a;
                for (var l, h, d = u[0]; ; ) {
        ...
        function Ze(s, u) {
            ...
            return function (t, e, n, i) {
                ...
                for (var a, o = t; 0 < n ? e < o : o < e; o -= r)
                    i.point(
                        (a = le([c, -l * Math.cos(o), -l * Math.sin(o)]))[0],
                        a[1]
                    );
            };
        }
        ...
        function fn(t, e, n) {
            return (
                (n[0] - e[0]) * (t[1] - e[1]) < (n[1] - e[1]) * (t[0] - e[0])
            );
        }
        function gn(t, e, n, i) {
            var r = t[0],
        ...
        function Nn(t, e) {
            var n,
                ...
                a = t.sort(Fn).pop();
            for (
                zo = [], Xo = new Array(t.length), Ho = new kn(), Bo = new kn();
                ;

            )
                if (
                    ((r = Yo),
                    a && (!r || a.y < r.y || (a.y === r.y && a.x < r.x)))
                )
                    (a.x === n && a.y === i) ||
        ...
        function ri(t) {
            ...
            r[0] * a[1] < a[0] * r[1] &&
                ((r[0] *= -1), (r[1] *= -1), (o *= -1), (s *= -1)),
                (this.rotate =
                    (o ? Math.atan2(r[1], r[0]) : Math.atan2(-a[0], a[1])) *
                    Ca),
            ...
            if (n) {
                ...
                s[7] ||
                    (s[7] =
                        ...
                        (a = ar((r = o)[2])),
                        i in ss
                            ? Math.abs(a - ar(Math.max(ia(r[0]), ia(r[1])))) +
                              +("e" !== i)
                            : a - 2 * ("%" === i))),
                    (n = s.join(""));
            } else n = ",." + ar(o[2]) + "f";
        ...
        function gr(t, e, n, i, r) {
            var a = t[0] - e[0],
                ...
                w =
                    (_ < 0 ? -1 : 1) *
                    Math.sqrt(Math.max(0, y * y * v - m * m)),
                S = (m * _ - x * w) / v,
                b = (-m * x - _ * w) / v,
                A = (m * _ + x * w) / v,
                T = (-m * x + _ * w) / v,
        ...
        function mr(t, e) {
            if (
                e.length < 1 ||
                (t.length != e.length && t.length != e.length + 2)
            )
                return xr(t);
        ...
        function Rr(i) {
            return function () {
                ...
                (t = this[i]) &&
                    ...
                    (t.active += 0.5),
                    n.event &&
                        n.event.interrupt.call(this, this.__data__, n.index));
            };
        }
        function Or(t, e, n) {
        ...
        function Fr(a, o, r, s, t) {
            ...
            function u(t) {
                for (var e = t / h, n = d(e), i = f.length; 0 < i; )
                    f[--i].call(a, n);
                return 1 <= e
        ...
        e(v, {
            ...
            (qr.nest = function () {
                function h(n, t, i) {
                    if (i >= p.length)
                        return f ? f.call(g, t) : d ? t.sort(d) : t;
                    for (
                        var e,
                            r,
                            a,
        ...
        (qr.ns = {
            ...
            (da.order = function () {
                for (var t = -1, e = this.length; ++t < e; )
                    for (
                        var n, i = this[t], r = i.length - 1, a = i[r];
                        0 <= --r;
        ...
        (qr.selection.enter = H),
            ...
            (pa.select = function (t) {
                for (
                    var e, n, i, r, a, o = [], s = -1, u = this.length;
                    ++s < u;
                    ...
                    for (var c = -1, l = r.length; ++c < l; )
                        (a = r[c])
                            ? (e.push(
                                  (i[c] = n =
                                      t.call(r.parentNode, a.__data__, c, s))
                              ),
        ...
        (qr.touch = function (t, e, n) {
            if (
                (arguments.length < 3 && ((n = e), (e = w().changedTouches)), e)
            )
            ...
            (qr.behavior.drag = function () {
                ...
                function t(l, h, d, f, g) {
                    return function () {
                        var i,
                            t =
                                qr.event.target.correspondingElement ||
                                qr.event.target,
                            r = this.parentNode,
                        ...
                        x
                            ? (i = [
                                  (i = x.apply(this, arguments)).x - c[0],
                                  i.y - c[1],
                              ])
                            : (i = [0, 0]),
                            a({ type: "dragstart" });
        ...
        (qr.timer = function () {
            ...
            (qr.round = function (t, e) {
                return e
                    ? Math.round(t * (e = Math.pow(10, e))) / e
                    : Math.round(t);
            });
        var Ua = [
            "y",
        ...
        qr.formatPrefix = function (t, e) {
            ...
            return (
                (t = +t) &&
                    ...
                    (n = Math.max(
                        -24,
                        Math.min(24, 3 * Math.floor((n - 1) / 3))
                    ))),
                Ua[8 + n / 3]
            );
        };
            ...
            [
                ...
                var e = (Qa[t] = Vt(
                    ...
                    function (t) {
                        ...
                        return (
                            Math.floor((Qa.dayOfYear(t) + ((e + n) % 7)) / 7) -
                            (e !== n)
                        );
                    }
                ));
        ...
        qr.locale = function (t) {
            return {
                    ...
                    function (t) {
                        ...
                        return function (t) {
                            ...
                            var u =
                                ...
                                c =
                                    u < g
                                        ? new Array((u = g - u + 1)).join(l)
                                        : "";
                            return (
                                b &&
                                    (r = T(
                                        c + r,
                                        c.length ? g - a.length : 1 / 0
                                    )),
                                (n += y),
                                (t = r + a),
                                ("<" === h
                ...
                timeFormat: (function (t) {
                    ...
                    function r(t, e, n, i) {
                        for (
                            var r, a, o, s = 0, u = e.length, c = n.length;
                            s < u;
        ...
        var bo,
            ...
            Mo = {
                ...
                polygonEnd: function () {
                    (Mo.lineStart = Mo.lineEnd = Mo.point = _),
                        (bo += ia(Ao / 2));
                },
            },
            Eo = {
        ...
        (qr.geo.path = function () {
            function e(t) {
                return (
                    t &&
                        ("function" == typeof u &&
                            o.pointRadius(+u.apply(this, arguments)),
                        (s && s.valid) || (s = a(o)),
                        qr.geo.stream(t, s)),
                    o.result()
                );
            ...
            (qr.geo.interpolate = function (t, e) {
                return (
                    ...
                    (g =
                        2 *
                        Math.asin(Math.sqrt(tt(a - i) + o * u * tt(r - n)))),
                    (p = 1 / Math.sin(g)),
                    ((x = g
                        ? function (t) {
        ...
        (Fo.area = function () {
            for (
                var t, e = -1, n = this.length, i = this[n - 1], r = 0;
                ++e < n;
                ...
                return (
                    ...
                    (r.start = function () {
                        ...
                        var s,
                            ...
                            i = v[1];
                        for (s = 0; s < c; ++s)
                            ((e = b[s]).index = s), (e.weight = 0);
                        for (s = 0; s < l; ++s)
                            "number" == typeof (e = A[s]).source &&
                                (e.source = b[e.source]),
        ...
        (qr.layout.hierarchy = function () {
            function s(t) {
                ...
                for (t.depth = 0; null != (e = n.pop()); )
                    if (
                        (i.push(e),
                        (a = c.call(s, e, e.depth)) && (r = a.length))
                    ) {
                        for (var r, a, o; 0 <= --r; )
                            n.push((o = a[r])),
                                (o.parent = e),
                        ...
                        l && (e.value = +l.call(s, e, e.depth) || 0),
                            delete e.children;
                return (
                    yi(t, function (t) {
                        var e, n;
        ...
        qr.layout.stack = function () {
            function h(t, e) {
                ...
                for (s = 0; s < l; ++s)
                    for (
                        p.call(h, n[0][s], (u = c[s]), i[0][s][1]), o = 1;
                        o < a;
                        ++o
                    )
            ...
            return (
                ...
                (h.order = function (t) {
                    return arguments.length
                        ? ((f = "function" == typeof t ? t : rs.get(t) || Ci),
                          h)
                        : f;
                }),
                (h.offset = function (t) {
                    return arguments.length
                        ? ((g = "function" == typeof t ? t : as.get(t) || Li),
                          h)
                        : g;
                }),
                (h.x = function (t) {
                    ...
                    var n = g.call(this, t, e),
                        ...
                        r = (function (t) {
                            for (
                                ...
                                for (
                                    var r, a = e.children, o = 0, s = a.length;
                                    o < s;
                                    ++o
                                )
                                    i.push(
                ...
                function o(t) {
                    ...
                    if (e && e.length) {
                        var n,
                            ...
                            a = [];
                        for (
                            l(r, (i.dx * i.dy) / t.value), a.area = 0;
                            (n = r.pop());
                ...
                normal: function (i, r) {
                    ...
                    return (
                        ...
                        function () {
                            ...
                            return (
                                i + r * t * Math.sqrt((-2 * Math.log(n)) / n)
                            );
                        }
                    );
                },
            ...
            return (function t(e, u, c, l) {
                ...
                return (
                    ...
                    (r.domain = function (t) {
                        return arguments.length
                            ? ((c = 0 <= t[0]),
                              e.domain((l = t.map(Number)).map(h)),
                              r)
                            : l;
                    }),
                    (r.base = function (t) {
                        return arguments.length
                            ? ((u = +t), e.domain(l.map(h)), r)
                            : u;
                    }),
                    (r.nice = function () {
            ...
            (qr.scale.ordinal = function () {
                return (function t(s, u) {
                    function c(t) {
                        return h[
                            ((r.get(t) ||
                                ("range" === u.t ? r.set(t, s.push(t)) : NaN)) -
                                1) %
                                h.length
                        ];
                    }
        ...
        var ls = [
                2062260, 16744206, 2924588, 14034728, 9725885, 9197131,
                14907330, 8355711, 12369186, 1556175,
            ].map(gt),
            hs = [
                2062260, 11454440, 16744206, 16759672, 2924588, 10018698,
                14034728, 16750742, 9725885, 12955861, 9197131, 12885140,
                14907330, 16234194, 8355711, 13092807, 12369186, 14408589,
                1556175, 10410725,
            ].map(gt),
            ds = [
                3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115,
                13556636, 9202993, 12426809, 15186514, 15190932, 8666169,
                11356490, 14049643, 15177372, 8077683, 10834324, 13528509,
                14589654,
            ].map(gt),
            fs = [
                3244733, 7057110, 10406625, 13032431, 15095053, 16616764,
                16625259, 16634018, 3253076, 7652470, 10607003, 13101504,
                7695281, 10394312, 12369372, 14342891, 6513507, 9868950,
                12434877, 14277081,
            ].map(gt);
        (qr.scale.quantile = function () {
            ...
            (qr.scale.quantize = function () {
                return (function t(e, n, i) {
                    function r(t) {
                        return i[
                            Math.max(0, Math.min(s, Math.floor(o * (t - e))))
                        ];
                    }
                    function a() {
        ...
        var ps = qr.map({
            ...
            "basis-open": function (t) {
                ...
                for (
                    var e, n = [], i = -1, r = t.length, a = [0], o = [0];
                    ++i < 3;
            ...
            "cardinal-closed": function (t, e) {
                return t.length < 3
                    ...
                    : t[0] +
                          mr(
                              (t.push(t[0]), t),
                              wr([t[t.length - 2]].concat(t, [t[1]]), e)
                          );
            },
            monotone: function (t) {
        ...
        (qr.svg.line.radial = function () {
            ...
            (qr.svg.symbol = function () {
                function e(t, e) {
                    return (ys.get(n.call(this, t, e)) || kr)(
                        i.call(this, t, e)
                    );
                }
                var n = Gr,
            ...
            (Ts.each = function (i, n) {
                ...
                if (arguments.length < 2) {
                    ...
                    X(this, function (t) {
                        ...
                        (
                            e.event ||
                            (e.event = qr.dispatch("start", "end", "interrupt"))
                        ).on(i, n);
                    });
                return this;
            }),
        ...
        qr.svg.brush = function () {
            function v(t) {
                t.each(function () {
                    ...
                    T &&
                        ((i = Qi(T)),
                        a.attr("x", i[0]).attr("width", i[1] - i[0]),
                        m(r)),
                        P &&
                            ((i = Qi(P)),
            ...
            function o() {
                function t() {
                    ...
                    i && ((t[0] += i[0]), (t[1] += i[1])),
                        ...
                        e &&
                            (y(s),
                            o({ type: "brush", mode: d ? "move" : "resize" }));
                }
                function n(t, e, n) {
                    var i,
                        r,
                    ...
                    return (
                        d && ((o -= u), (s -= l + u)),
                        (i = (n ? E : M)
                            ? Math.max(o, Math.min(s, t[n]))
                            : t[n]),
                        d
                            ? (r = (i += u) + l)
                            : (h &&
                                  (u = Math.max(o, Math.min(s, 2 * h[n] - i))),
                              u < i ? ((r = i), (i = u)) : (r = u)),
                        c[0] != i || c[1] != r
                            ? (n ? (b = null) : (S = null),
                              (c[0] = i),
        ...
        var Rs = [
                1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5,
                432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6,
            ],
            Os = [
                [Qa.second, 1],
                [Qa.second, 5],
