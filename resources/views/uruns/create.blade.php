    ...
    <div class="row clearfix">
        <div class="card">
            ...
            <ul class="nav nav-tabs" id="myTabs">
                <li class="nav-item">
                    <a class="nav-link active" id="urunler-tab" data-toggle="tab" href="#urunler">Ürünler</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="hizmetler-tab" data-toggle="tab" href="#hizmetler">Hizmetler</a>
                </li>
            </ul>
            <!-- Sekme İçeriği -->
            <div class="tab-content mt-2">
                <table class="table">
                    ...
                    <div class="tab-pane fade" id="hizmetler">
                        <!-- Alt Tab Kontrol -->
                        <ul class="nav nav-tabs mt-3" id="hizmetlerAltTabs">
                            <!-- Hizmetler Tabının Alt Tabları -->
                            <li class="nav-item">
                                <a class="nav-link active" id="hizmetBilgi-tab" data-toggle="tab" href="#hizmetBilgi">Bilgiler</a>
                            </li>
                            <li class="nav-item">
